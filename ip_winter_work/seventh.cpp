...
{
    Mat image = imread("/home/shashwat/OpenCVPrac/ip_winter_work/image.jpg",0);//see this is grayscale
        ...
        for(int j=0;j<image.cols;j++)
        {
            ...
            else 
            {
                filtered.at<uchar>(i,j) = 
                        0.0625*image.at<uchar>(i-1,j-1)+ //Oh man from where these values come from
